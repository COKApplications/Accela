/**
 * The below code is related to the ServiceRequest/ALLEY TRIMMING MOWING CLEARING/NA/NA record, with
 * an ApplicationStatusUpdateAfter event. 
 * ASUA:SERVICEREQUEST/ALLEY TRIMMING MOWING CLEARING/NA/NA 
 */

if(appStatus == "Assigned To Dept") {
  //Start Script PS28 Alley Trimming Mowing Cleaning
  ...
  editAppSpecific("Work Order Type", "PS28 Alley Trimming Mowing Cleaning", childId);
  ...
  workOrderType = "PS28 Alley Trimming Mowing Cleaning"
