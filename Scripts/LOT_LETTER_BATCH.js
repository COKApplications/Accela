...
capModel.setCapStatus("In Violation");
var capList = aa.cap.getCapIDListByCapModel(capModel).getOutput();

mySet = new capSet("Lot Letter","Test Set for Lot Letter");

for (var member in capList)
{
var capId = capList[member].getCapID();
mySet.add(capId,"In Process");
}
//mySet.type = "Lot Letter";
//mySet.status = "In Process";
//mySet.update();
