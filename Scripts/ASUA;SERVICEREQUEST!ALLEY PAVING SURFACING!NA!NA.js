/**
 * The below code is related to the ServiceRequest/Alley Paving Surfacing/NA/NA record, with
 * an ApplicationStatusUpdateAfter event. 
 * ASUA:SERVICEREQUEST/Alley Paving Surfacing/NA/NA 
 */

if(appStatus == "Assigned To Dept") {
		//Start Script PS08 Alley Paving/Surfacing
		var myArray = [["What is the nature of the request?: ", workDescGet(capId)], 
		               ["What is the name of the street(s) connecting to the alley?: ", AInfo["What is the name of the street(s) connecting to the alley?"]], 
		               ["Is the alley graveled or asphalt?: ", AInfo["Is the alley graveled or asphalt?"]],
		               ["What is the problem with the current alley surface?: ", AInfo["What is the problem with the current alley surface?"]],
		...
		editAppSpecific("Work Order Type", "PS08 Alley Paving/Surfacing", childId);
		...
		workOrderType = "PS08 Alley Paving/Surfacing"
