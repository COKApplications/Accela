/**
 * The below code is related to the ServiceRequest/Construction Contractor Complaint/NA/NA record, with
...
var emailTo = lookup("COK_Service_Request_Email_To", "KNOXVILLE/KNOX/ENG/STORM/CONSTCONTR/NA/NA");
var emailSubject = "A new Construction Contractor Complaint Service Request has been added. " + alternateId;
var natureOfRequest = workDescGet(capId);
var complaintDetail = AInfo["Describe Details of the Complaint:"];
var locationDetail = AInfo["Describe Location of the Complaint in Detail:"];
var contractorDetail = AInfo["Contractor Name if known:"];
var locationInfo = "";
var contactInfo = "";
...
if(isEmpty(complaintDetail)) {
	complaintDetail = "<< No information provided by caller. >>";
}
...
if(isEmpty(contractorDetail)) {
	contractorDetail = "<< No information provided by caller. >>";
}
...
"Describe details of the complaint. - " + contractorDetail + "<br>" + "<br>" +
"Describe location in detail. - " + locationDetail + "<br>" + "<br>" +
"Contractor name if known. - " + contractorDetail + "<br>" + "<br>" +
