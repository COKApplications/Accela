/**
 * The below code is related to the ServiceRequest/Leaf Pick-Up Request/NA/NA record, with
 * an ApplicationStatusUpdateAfter event. 
 */


if(appStatus == "Assigned To Dept") {
		//Start Script PS07 Leaf Pickup Request
		var myArray = [["What is the nature of the request?: ", workDescGet(capId)], 
		               ["Are leaves ready for pickup or have been missed?: ", AInfo["Are leaves ready for pickup or have been missed?"]], 
		               ["Is this a residential, church, or business request?: ", AInfo["Is this a residential, church, or business request?"]],
		...
		editAppSpecific("Work Order Type", "PS07 Leaf Pickup Request", childId);
		...
		workOrderType = "PS07 Leaf Pickup Request"
