...
{	
	...
	for (curRecord in resultObjArray)
		...
		updateAppStatus("In Violation","");
		activateTask("Letter Notice");
		var lastInspect = getLastInspector("LOT Initial Inspection");
		scheduleInspection("LOT Re-Inspection",14,lastInspect);
		}
