/**
 * The below code is related to the ServiceRequest/BRUSH PICKUP REQUEST/NA/NA record, with
 * an ApplicationStatusUpdateAfter event. 
 * ASUA:SERVICEREQUEST/BRUSH PICKUP REQUEST/NA/NA 
 */

if(appStatus == "Assigned To Dept") {
  //Start Script PS01 Brush Pickup Request
  var myArray = [["What is the nature of the request?: ", workDescGet(capId)], 
                 ["Who cut the brush?: ", AInfo["Who cut the brush?"]], 
                 ["Is this a residential, church, business, or city employee request?: ", AInfo["Is this a residential, church, business, or city employee request?"]],
                 ["Is brush ready for pickup or has been missed?: ", AInfo["Is brush ready for pickup or has been missed?"]],
  ...
  editAppSpecific("Work Order Type", "PS01 Brush Pickup Request", childId);
  ...
  workOrderType = "PS01 Brush Pickup Request"
