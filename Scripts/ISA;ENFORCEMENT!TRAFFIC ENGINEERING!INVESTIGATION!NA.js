...
if (inspType == "TE Initial Inspection") {
 ...
 // var emailTo = "grandles@knoxvilletn.gov"; 
    var emailTo = vinspInspector + "knoxvilletn.gov";
    var emailSubject = "Traffic Engineering Investigation Assignment. " + alternateId;
    var natureOfRequest = workDescGet(capId);
    var Priority = AInfo["Priority:"];
    var IncidentType = AInfo["IncidentType:"];
