/** 
* The below code is related to the SERVICEREQUEST/STREET SIDEWALK CLEAN CLEAR/NA/NA record, with
* an ApplicationStatusUpdateAfter event. 
* ASUA:SERVICEREQUEST/STREET SIDEWALK CLEAN CLEAR/NA/NA
*/
if(appStatus == "Assigned To Dept") {

//Start Script PS02 Street/Sidewalk Cleaning/Clearing
var myArray = [["What is the nature of the request?: ", workDescGet(capId)], 
["Is this litter for hand pick up or dirt / mud / sand, etc. for sweeping?: ", AInfo["Is this litter for hand pick up or dirt / mud / sand, etc. for sweeping?"]], 
["Is debris in the street causing a hazard?: ", AInfo["Is debris in the street causing a hazard?"]],
["Is the debris from a construction site?: ", AInfo["Is the debris from a construction site?"]],
["What type of debris is in the street or on the sidewalk?: ", AInfo["What type of debris is in the street or on the sidewalk?"]],
...
editAppSpecific("Work Order Type", "PS02 Street/Sidewalk Cleaning/Clearing", childId);
...
workOrderType = "PS02 Street/Sidewalk Cleaning/Clearing"
