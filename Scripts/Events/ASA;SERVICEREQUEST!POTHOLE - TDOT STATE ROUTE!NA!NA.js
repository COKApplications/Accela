/**
 * The below code is related to the ServiceRequest/Pothole - TDOT State Route/NA/NA record, with
...
if(addrsObj.getSuccess() ) {
	...
	if(isEmpty(dupeList) == true) {
		...
		var emailTo = lookup("COK_Service_Request_Email_To", "KNOXVILLE/POTHOLE-TDOT/NA/NA/NA");
		var emailSubject = "A new Pothole - TDOT State Route Request has been added. " + alternateId;
