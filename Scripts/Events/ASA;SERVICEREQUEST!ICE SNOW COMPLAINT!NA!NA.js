/**
 * The below code is related to the ServiceRequest/Ice Snow Complaint/NA/NA record, with
...
if(addrsObj.getSuccess() ) {
	...
	if(isEmpty(dupeList) == true) {
		//Start Script PS03 Ice/Snow Removal
		var myArray = [["What is the nature of the request?: ", workDescGet(capId)], 
		               ["Is the problem ice or snow?: ", AInfo["Is the problem ice or snow?"]], 
		               ["What is the exact location (curve, interstate, bridge, etc)?: ", AInfo["What is the exact location (curve, interstate, bridge, etc)?"]],
		               ["Additional Details:  e.g. direction, proximity, etc.?: ", AInfo["Additional Details:  e.g. direction, proximity, etc."]],
		...
		editAppSpecific("Work Order Type", "PS03 Ice/Snow Removal", childId);
		...
		workOrderType = "PS03 Ice/Snow Removal"
		copyParcelGisObjects();serviceArea = getGISInfo("KGIS","Public Service Zones","Zone_");
