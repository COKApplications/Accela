/**
 * The below code is related to the SERVICEREQUEST/COURTESY BOX DUMPSTER REQUEST/NA/NA record, with
 * an ApplicationStatusUpdateAfter event. 
 * ASUA:SERVICEREQUEST/COURTESY BOX DUMPSTER REQUEST/NA/NA
 */

if(appStatus == "Assigned To Dept") {
  //Start Script PS05 Courtesy Box/Dumpster Request	
  ...
  editAppSpecific("Work Order Type", "PS05 Courtesy Box/Dumpster Request", childId);
  ...
  workOrderType = "PS05 Courtesy Box/Dumpster Request"
