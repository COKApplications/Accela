...
var myArray = [["Detailed Description: ", detailedDescription],
               ...
               ["Vacant or Improved: ", AInfo["Vacant or Improved"]],
               ["Post Notice: ", AInfo["Post Notice"]],
               ["Mail Notice: ", AInfo["Mail Notice"]],
               ["Re-Inspection Days: ", AInfo["Re-Inspection Days"]]];
var parentId = createParent("ServiceRequest","Lot Complaint","NA","NA");
...
if(autoInspector != "No Inspector") {
	scheduleInspectDate("LOT Initial Inspection", nextWorkDay(), autoInspector, "", "Scheduled by Script.");
}
