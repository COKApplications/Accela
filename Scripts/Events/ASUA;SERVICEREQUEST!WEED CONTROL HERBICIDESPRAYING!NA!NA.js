/**
 * The below code is related to the SERVICEREQUEST/WEED CONTROL HERBICIDESPRAYING/NA/NA record, with
 * an ApplicationStatusUpdateAfter event. 
 * ASUA:SERVICEREQUEST/WEED CONTROL HERBICIDESPRAYING/NA/NA
 */

if(appStatus == "Assigned To Dept") {

  //Start Script PS18 Weed Control/Herbicide Spraying
  var myArray = [["What is the nature of the request?: ", workDescGet(capId)], 
                 ["Describe the weed problem?: ", AInfo["Describe the weed problem?"]], 
  ...
  editAppSpecific("Work Order Type", "PS18 Weed Control/Herbicide Spraying", childId);
  ...
  workOrderType = "PS18 Weed Control/Herbicide Spraying"
