...
if (wfTask == "Open" && (wfStatus == "Sent To Sign Making")) {
                updateAppStatus("Sent to Sign Making", "Updated by Script.");
} 

if (wfTask == "Open" && (wfStatus == "Sign Making Complete")) {
                updateAppStatus("Sign Complete", "Updated by Script.");
}
