/**
 * The below code is related to the ServiceRequest/Street Marking Investigation/NA/NA record, with
...
if(addrsObj.getSuccess() ) {
	...
	if(addrs[0] != null){
		...
		//get cap List
		var capList = getRecordsByAddressIdBuffer(addrId,"KGIS","Parcels","PARCELID","300");
		//filter duplicates
