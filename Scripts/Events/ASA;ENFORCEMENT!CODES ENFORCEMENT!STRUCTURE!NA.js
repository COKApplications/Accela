...
//Start Script 15 - Create Structure Parent Record
var detailedDescription = workDescGet(capId);
var myArray = [["Detailed Description: ", detailedDescription],
               ["Type of Structure: ", AInfo["Type of Structure"]],
               ["Number of Accessory Structures: ", AInfo["Number of Accessory Structures"]],
               ["Occupancy Status: ", AInfo["Occupancy Status"]],
               ["Historic Property: ", AInfo["Historic Property"]]];
var parentId = createParent("ServiceRequest","Structure Complaint","NA","NA");
...
if(autoInspector != "No Inspector") {
	scheduleInspectDate("STR Initial Inspection", nextWorkDay(), autoInspector, "", "Scheduled by Script.");
}
