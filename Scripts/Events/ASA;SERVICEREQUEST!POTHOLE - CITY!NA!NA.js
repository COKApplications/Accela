/**
 * The below code is related to the ServiceRequest/Pothole - City/NA/NA record, with
...
if(addrsObj.getSuccess() ) {
	...
	if(isEmpty(dupeList) == true) {
		//Start Script 33 - Create Pothole - City Work Order
		...
		editAppSpecific("Work Order Type", "PS10 Pothole", childId);
		...
		//RFS 28702 02/28/19 Default PS Pothole to Eddie Warren
		//foreman = lookup("COK_Public_Service_Foremen", assignedDepartment);
                foreman = lookup("COK_Public_Service_Foremen", "PS10 Pothole Patching");
		assignedDepartment = "KNOXVILLE/KNOX/PS/CONSTRUC/NA/NA/NA";
		...
		var emailSubject = "A new Pothole - City Service Request has been added. " + alternateId;
