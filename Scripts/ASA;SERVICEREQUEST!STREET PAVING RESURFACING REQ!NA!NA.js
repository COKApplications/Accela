/**
 * The below code is related to the ServiceRequest/Street Paving Resurfacing Req/NA/NA record, with
...
var emailSubject = "A new Street Paving Resurfacing Service Request has been added. " + alternateId;
var natureOfRequest = workDescGet(capId);
var locationDetail = AInfo["Is this an alley?"];
var locationInfo = "";
var contactInfo = "";
...
"Is this an alley? - " + locationDetail + "<br>" + "<br>" +
