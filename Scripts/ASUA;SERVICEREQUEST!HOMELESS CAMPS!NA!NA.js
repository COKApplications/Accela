/**
 * The below code is related to the SERVICEREQUEST/HOMELESS CAMPS/NA/NA record, with
 * an ApplicationStatusUpdateAfter event. 
 * ASUA:SERVICEREQUEST/HOMELESS CAMPS/NA/NA
 */

if(appStatus == "Assigned To Dept") {
  //Start Script PS31 Homeless Camps
  var myArray = [["What is the nature of the request?: ", workDescGet(capId)], 
                 ["Is this a KPD initiated Request?: ", AInfo["Is this a KPD initiated Request?"]], 
                 ["Could you please provide detailed location information?: ", AInfo["Could you please provide detailed location information?"]],
  ...
  editAppSpecific("Work Order Type", "PS31 Homeless Camps", childId);
  ...
  workOrderType = "PS31 Homeless Camps"
