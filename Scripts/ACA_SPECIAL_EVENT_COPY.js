...
//var v_date_time_of_teardown = AInfo["Date & Time of Teardown"];
...
//17EST-00000-00682
 ...
 //   var v_event_name = getASIFieldValue(parentCapId,"SPECIAL EVENT","Event Name");	
  //  editAppSpecific("Event Name",v_event_name, targetCapId);
//  editAppSpecific("Event Location",v_event_location, targetCapId);
//  editAppSpecific("Event Start Date",v_event_start_date, targetCapId);
//  editAppSpecific("Event End Date",v_event_end_date, targetCapId);
//  editAppSpecific("Time of Event",v_time_of_event, targetCapId);
//  editAppSpecific("Presenting Organization",v_presenting_organization, targetCapId);
//  editAppSpecific("Date & Time of Setup",v_date_time_of_setup, targetCapId);
//  editAppSpecific("Date & Time of Teardown",v_date_time_of_teardown, targetCapId);
    ...
    {  
		...
		//copyAppSpecificTable(parentCapId, targetCapId);
                var v_ignore = "MUSIC,VENDORS,TENTS,PORT-A-LETS,INFLATABLES,ALCOHOL,ANIMALS,ROAD CLOSURES, SECURITY AND SAFETY, SPECIAL REQUESTS, SPECIAL EVENTS CITY SERVICES, ADDITIONAL FORMS NEEDED, ACKNOWLEDGEMENT";
 		//copyASIFields(parentCapId, targetCapId, v_ignore);   
