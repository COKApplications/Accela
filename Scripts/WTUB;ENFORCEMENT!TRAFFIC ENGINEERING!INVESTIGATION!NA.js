...
//if((wfTask == "Set Action Type and Recommendation") &&
//  (wfStatus == "Completed" || "Approved")) {
//  var ActionType = AInfo["Action Type"];
//  var ServiceRequestType = AInfo["Transfer-Service Request Type"];
//  if (ActionType == "Transfer To Civil Enginering" || "Transfer To Stormwater") {
//   if(isEmpty(ServiceRequestType) == true) { 
//   showMessage = true;
//   comment("****Transer-Service Request Type Is Missing");
//   cancel = true;
//    }
//}
//}
