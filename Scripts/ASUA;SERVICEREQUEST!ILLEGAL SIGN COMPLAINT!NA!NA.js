/**
 * The below code is related to the SERVICEREQUEST/ILLEGAL SIGN COMPLAINT/NA/NA record, with
 * an ApplicationStatusUpdateAfter event.
 */

if(appStatus == "Assigned To Dept") {
		//Start Script PS32 Illegal Sign Complaint
		var myArray = [["What is the nature of the request?: ", workDescGet(capId)], 
		               ["Is the sign causing a traffic hazard or blocking traffic sight distance?: ", AInfo["Is the sign causing a traffic hazard or blocking traffic sight distance?"]], 
		               ["Could you please describe the sign?: ", AInfo["Could you please describe the sign?"]],
		...
		editAppSpecific("Work Order Type", "PS32 Illegal Sign Removal", childId);
		...
		workOrderType = "PS32 Illegal Sign Removal"
