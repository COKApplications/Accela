/**
 * The below code is related to the SERVICEREQUEST/Miscellaneous Request/NA/NA  record, with
...
editAppSpecific("Intersection", gisIdForLayer);
		...
		var emailTo = lookup("COK_Service_Request_Email_To", "KNOXVILLE/KNOX/311/NA/NA/NA/NA");
		var emailSubject = "A new Miscellaneous Request Service Request has been added. " + alternateId;
		var natureOfRequest = workDescGet(capId);
		var departmentsInvolved = AInfo["Which city departments are involved?"];
		var locationInfo = "";
		var contactInfo = "";
		...
		if(isEmpty(departmentsInvolved)) {
		...
		"Which city departments are involved? - " + departmentsInvolved + "<br>" + "<br>" +
