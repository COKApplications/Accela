...
if(inspType == "SW Inspection") {
	...
	else if (inspResult == "Referred to KUB" || inspResult == "Referred to TDEC" || inspResult == "Referred to TDOT" ||
		...
		if (tContact["email"] != null){
			...
			if (contactType.toUpperCase() == "CITIZEN"){
			   ...
			   var inspComment = inspResult + " - " + v_actionrecommendation;
				...
				//showMessage = true;
				//comment("Sending email from IRSA script");
				//HD call - comment out actual email send at this time
