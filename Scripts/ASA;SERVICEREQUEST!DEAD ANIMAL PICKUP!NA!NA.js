/**
 * The below code is related to the ServiceRequest/Dead Animal Pickup/NA/NA record, with
...
if(addrsObj.getSuccess() ) {
	...
	if(isEmpty(dupeList) == true) {
		//Start Script PS19 Dead Animal Pickup
		var myArray = [["What is the nature of the request?: ", workDescGet(capId)], 
		               ["Where is the animal located?: ", AInfo["Where is the animal located?"]], 
                               ["If this is a vet clinic, what is the name of the person who will be available to load the animal?: ", AInfo["If this is a vet clinic, what is the name of the person who will be available to load the animal?"]],
		...
		editAppSpecific("Work Order Type", "PS19 Dead Animal Pickup", childId);
		...
		workOrderType = "PS19 Dead Animal Pickup"
		copyParcelGisObjects();serviceArea = getGISInfo("KGIS","Public Service Zones","Zone_");
